...
<link href="../styles/xslt-style.css" rel="stylesheet" type="text/css" />
    ...
    <img src="../assets/images/ines-avatar.png" alt="Inês's Eagle Avatar"
       ...
       <!-- Back Button -->
        <a href="../pages/works.html" style="text-decoration: none; width:125px; padding: 10px; background-color: #e27b0c; color: #ffffff; border-radius: 5px;">
          Back to Works
        </a>
